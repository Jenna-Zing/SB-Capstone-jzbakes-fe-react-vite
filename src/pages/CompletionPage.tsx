              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 max-w-md w-full mb-8">
                <table className="w-full">
                  <tbody className="divide-y divide-gray-100">
                    <tr>
                      <td className="py-3 text-left font-medium text-gray-500">
                        Transaction ID
                      </td>
                      <td className="py-3 text-right font-mono text-sm text-gray-700 break-all">
                        {intentId}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="py-3 text-right font-medium text-gray-900 capitalize">
                        {status}
                      </td>
                    </tr>
                  </tbody>
